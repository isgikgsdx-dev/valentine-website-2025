...
const CONFIG = {
    ...
    questions: {
        ...
        third: {
            text: "Quieres ser mi San Valentin? 🌹", // The big question!
            yesBtn: "Si!",                                             // Text for "Yes" button
            noBtn: "No"                                                 // Text for "No" button
        }
    },
    ...
    loveMessages: {
        extreme: "Me amas tantooo? 🥰🚀💝",  // Shows when they go past 5000%
        high: "De aqui a la luna a pasitos de medusa! 🚀💝",              // Shows when they go past 1000%
        normal: "me caes bien! "                           // Shows when they go past 100%
    },
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/depib5hk7/video/upload/v1770528764/Jorge_Cuellar_Caztro_-_tqcm_LetraLyrics_exjezl.mp3", // Music streaming URL
